...
func HandleMutate(w http.ResponseWriter, r *http.Request) {
	...
	// Uncomment below to annotate Pods
	...
	// annotations["test-annotation"] = "true"
	...
	// Uncomment below to annotate replicasets

	var rs appsV1.ReplicaSet

	err = json.Unmarshal(admissionReviewReq.Request.Object.Raw, &rs)

	if err != nil {
		fmt.Errorf("could not unmarshal rs on admission request: %v", err)
	}

	var patches []patchOperation

	annotations := rs.ObjectMeta.Annotations
	annotations["test-annotation"] = "true"
	...
	// Common for any resource to be patched
